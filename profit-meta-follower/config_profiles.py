...
COPY_CANDIDATE_SCAN = 100
COPY_FILL_FETCH_MAX = 110
COPY_MAX_ROI = 0.0
COPY_MIN_EQUITY = 1000.0
COPY_REFRESH_HOURS = 4.0
COPY_INCOMPLETE_RETRY_MIN = 3.0
COPY_RESELECT_HOURS = 4.0
COPY_LOOKBACK_DAYS = 7.0
COPY_HISTORY_DAYS = 30.0
COPY_REJECT_TTL_H = 6.0
COPY_EXCLUDE_HOLDERS = True
COPY_MIN_BOARD_VOLUME = 25000.0
COPY_MIN_PNL_VOLUME_RATIO = 0.00005
COPY_REQUIRE_OPEN_POSITIONS = True
COPY_MIN_OPEN_NOTIONAL_USD = 200.0
COPY_MAX_LAST_FILL_H = 8.0
COPY_IDEAL_TRADES_PER_HOUR = 4.0
COPY_MIN_MEDIAN_GAP_S = 90.0
COPY_MAX_MEDIAN_GAP_S = 2400.0
COPY_MIN_FILLS = 12
COPY_MAX_FILLS = 0
COPY_MIN_FILLS_PER_DAY = 10.0
COPY_MAX_FILLS_PER_DAY = 280.0
COPY_MIN_WIN_RATE = 0.0
COPY_MIN_HIST_WIN_RATE = 0.0
COPY_MIN_RECENT_PNL = 1.0
COPY_MIN_HIST_PNL = 0.0
COPY_MIN_PROFIT_FACTOR = 0.0
COPY_MAX_FAST_FLIP_RATIO = 0.55
COPY_MIN_HOLD_S = 90.0
COPY_MAX_POSITIONS = 10
COPY_MIN_FRESH_LEADERS_PCT = 0.4
COPY_IDEAL_GAP_S = 180.0
COPY_REBALANCE_COOLDOWN_S = 45.0
COPY_FILL_SLEEP_S = 0.55
...
_TRADE: dict = {
    ...
    "COPY_REJECT_TTL_H": COPY_REJECT_TTL_H,
    "COPY_EXCLUDE_HOLDERS": COPY_EXCLUDE_HOLDERS,
    "COPY_MIN_BOARD_VOLUME": COPY_MIN_BOARD_VOLUME,
    "COPY_MIN_PNL_VOLUME_RATIO": COPY_MIN_PNL_VOLUME_RATIO,
    "COPY_REQUIRE_OPEN_POSITIONS": COPY_REQUIRE_OPEN_POSITIONS,
    "COPY_MIN_OPEN_NOTIONAL_USD": COPY_MIN_OPEN_NOTIONAL_USD,
    "COPY_MAX_LAST_FILL_H": COPY_MAX_LAST_FILL_H,
